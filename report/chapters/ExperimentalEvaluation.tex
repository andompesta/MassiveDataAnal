...
\begin{figure*}[htbp]
	\centering
			\begin{subfigure}[windows distance of 5 days]
					{\includegraphics[width=5cm,height=5cm]{image/win_0_rank_3.pdf}}	
			\end{subfigure}
			\begin{subfigure}[windows distance of 7 days]
					{\includegraphics[width=5cm,height=5cm]{image/win_1_rank_3.pdf}}	
			\end{subfigure}
			\begin{subfigure}[windows distance of 10 days]
					{\includegraphics[width=5cm,height=5cm]{image/win_2_rank_3.pdf}}	
			\end{subfigure}
			\begin{subfigure}[windows distance of 30 days]
					{\includegraphics[width=5cm,height=5cm]{image/win_3_rank_3.pdf}}	
			\end{subfigure}
			\caption[et-fixed-10days-r-nd]{Execution time for different neighbourhood distance }
	\label{fig:et-fixed-r3-winds}
\end{figure*} 
